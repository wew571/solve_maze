...
Path_Close_Astar = (100 , 100 , 135 , 1) 
Path_Close_BFS = (62 , 137 , 58 , 1)
...
UI_Back_Ground = (0 , 0 , 0 , 1)
UI_Title = (255 , 0 , 255, 1)
UI_Text = ( 0 , 255 , 0 , 1 )
UI_Status_Text = ( 0 , 255 , 255 , 1)
UI_Guide = ( 255 , 255 , 0 , 1 )
UI_Build_Maze_Text = (255 , 125 , 0 , 1)
...
History_Text = ( 255 , 255 , 255 , 1)
History_Status = ( 0 , 255 , 157 , 1 )
History_Error_Text = (  255 , 0 , 75 , 1 )

Compare_Back_Ground = (0 , 0 , 0 , 1)
Compare_Front_Title = ( 255 , 40 , 0 , 1)
Compare_Title = ( 255 , 255 , 0 , 1)
Compare_Text = ( 0 , 255 , 200 , 1)
Compare_Status = ( 255 , 0 , 255 , 1)
Compare_Error_Text = ( 255 , 0 , 100 , 1 )
